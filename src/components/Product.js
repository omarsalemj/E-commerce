                ...
                <div className='flex gap-4 items-center'>
                    <div className='w-52 flex items-center justify-between text-gray-500 gap-4 border p-3'>
                        ...
                        <div className='flex items-center gap-4 font-semibold'>
                            <button onClick={() => setBaseQty(baseQty === 1 ? baseQty = 1 : baseQty - 1)} className='border px-2 h-5 flex items-center text-lg hover:bg-gray-700 hover:text-white duration-200 active:bg-black'>-</button>
                            <span>{baseQty}</span>
                            <button onClick={() => setBaseQty(baseQty + 1)} className='border px-2 h-5 flex items-center text-lg hover:bg-gray-700 hover:text-white duration-200 active:bg-black'>+</button>
                        </div>
                    </div>
