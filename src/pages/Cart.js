...
const Cart = () => {
  ...
  return (
    <div>
      <img src='https://images.hdqwalls.com/download/swimming-pool-water-dt-2560x1440.jpg' alt='cartImg' className='w-full h-60 object-cover' />
        ...
        <div className='w-1/3 bg-[#fafafa] py-6 px-4'>
          <div className='flex flex-col gap-6 border-b-[1px] border-b-gray-400 pb-6'>
            ...
            <p className='flex items-start gap-4 text-base'>
              Shipping <span>Omar Salem youssef mahmoud hassan el-Jafaary omar Salem Ahmed Youssef.</span>
            </p>
          </div>
